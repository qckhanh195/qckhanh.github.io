      ...
      <div className="coming-soon-layout">
        ...
        <div className="coming-soon-left" style={{ flexDirection: 'column', gap: '2rem' }}>
          <TiltedCard
            ...
            altText="Quoc Khanh"
            captionText="Q1KA"
            containerHeight="clamp(220px, 60vw, 300px)"
            containerWidth="clamp(220px, 60vw, 300px)"
            imageHeight="clamp(220px, 60vw, 300px)"
            imageWidth="clamp(220px, 60vw, 300px)"
            rotateAmplitude={14}
            scaleOnHover={1.1}
            showTooltip={true}
            ...
            overlayContent={
              <div className="absolute bottom-4 left-4">
                <p className="text-white font-bold text-xl px-4 py-2 bg-black/40 rounded-xl backdrop-blur-md border border-white/10 shadow-lg">Quoc Khanh</p>
              </div>
            }
          />
          ...
          <div style={{ display: 'flex', gap: '1.5rem', marginTop: '1rem', zIndex: 10 }}>
            <a href="https://www.facebook.com/qckhanh.195" target="_blank" rel="noopener noreferrer" style={{ color: '#a5b4fc', transition: 'color 0.3s' }} onMouseEnter={(e) => e.target.style.color = '#ffffff'} onMouseLeave={(e) => e.target.style.color = '#a5b4fc'}>
        ...
        <div className="coming-soon-right">
          ...
          <a
            ...
            id="repo-link"
            style={{ display: 'inline-block', zIndex: 50, transition: 'transform 0.3s ease' }}
            onMouseEnter={(e) => e.currentTarget.style.transform = 'translateY(-2px)'}
            onMouseLeave={(e) => e.currentTarget.style.transform = 'translateY(0)'}
          >
            <img src="https://img.shields.io/badge/GitHub-qckhanh195%2Fqckhanh.github.io-181717?style=for-the-badge&logo=github" alt="GitHub Repository" style={{ borderRadius: '6px' }} />
          </a>
          ...
          <div ref={footerRef} className="coming-soon-footer">
            <p>© 2025 Quoc Khanh. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
